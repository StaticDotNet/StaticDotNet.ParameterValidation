...
namespace StaticDotNet.ParameterValidation
{
    public static class StringExtensions
    {
		...
		/// <summary>
		/// Validates that the parameter is not white space. Otherwise, an <see cref="System.ArgumentException" /> is thrown.
		/// </summary>
		/// <param name="validator">The <see cref="ParameterValidator{TParameter}" />.</param>
		/// <returns>The same instance of <see cref="ParameterValidator{TParameter}" />.</returns>
		/// <exception cref="System.ArgumentException">Thrown when the parameter is white space.</exception>
		public static ParameterValidator<string> IsNotWhiteSpace( this ParameterValidator<string> validator )
		{
			return validator.IsNotWhiteSpace( ExceptionMessages.VALUE_CANNOT_BE_WHITE_SPACE );
		}
